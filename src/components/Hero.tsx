  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center pt-32 pb-20 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
         ...
         {/* Aurora Glows */}
         <div className="absolute top-[-20%] left-[-10%] w-[70%] h-[70%] bg-indigo-600/10 rounded-full blur-[120px] animate-pulse" />
      ...
      <div className="relative z-20 max-w-5xl mx-auto px-6 w-full text-center">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 border border-white/10 backdrop-blur-md shadow-[0_0_15px_-3px_rgba(255,255,255,0.1)] hover:border-white/20 transition-colors cursor-default">
            ...
            <span className="text-xs font-medium text-zinc-300 tracking-wide">Accepting New Enterprise Clients for Q4</span>
          </div>
